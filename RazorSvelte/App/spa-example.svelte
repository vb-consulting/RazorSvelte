    ...
    <div class="container mt-3">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    class:active={hash == "#/parametrized/AAA"}
                    href="#/parametrized/AAA">Parametrized with "AAA"</a
                >
            </li>
            <li class="nav-item">
                <a
                    class="nav-link"
                    class:active={hash == "#/parametrized/BBB"}
                    href="#/parametrized/BBB">Parametrized with "BBB"</a
                >
            </li>
            <li class="nav-item">
