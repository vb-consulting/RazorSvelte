...
export function setErrorKey(value: string) {
    errorKey = value;
}
...
export function setCacheVersion(value: string) {
    cacheVersion = value;
}
export function setUrlPrefix(value: string) {
    urlPrefix = value;
}
export function setIndexUrl(value: string) {
    indexUrl = value;
}
export function setLogoutUrl(value: string) {
    logoutUrl = value;
}
export function setLoginUrl(value: string) {
    loginUrl = value;
}
export function setErrorUrl(value: string) {
    errorUrl = value;
}
export function setNotFoundUrl(value: string) {
    notFoundUrl = value;
}
