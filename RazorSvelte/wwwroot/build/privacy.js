var privacy = (function () {
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a1, "href", urls.privacyUrl);
    			toggle_class(a1, "active", document.location.pathname == urls.privacyUrl);
    			add_location(a1, file$2, 7, 4, 245);
    			attr_dev(li1, "class", "nav-item py-0");
    			add_location(li1, file$2, 6, 0, 213);
    			attr_dev(a2, "class", "nav-link");
    			attr_dev(a2, "href", urls.authorizedUrl);
    			toggle_class(a2, "active", document.location.pathname == urls.authorizedUrl);
    			add_location(a2, file$2, 10, 4, 403);
    			attr_dev(li2, "class", "nav-item py-0");
    			add_location(li2, file$2, 9, 0, 371);
    			attr_dev(a3, "class", "nav-link");
    			attr_dev(a3, "href", urls.spaUrl);
    			toggle_class(a3, "active", document.location.pathname == urls.spaUrl);
    			add_location(a3, file$2, 13, 4, 577);
    			attr_dev(li3, "class", "nav-item py-0");
    			add_location(li3, file$2, 12, 0, 545);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* App\privacy.svelte generated by Svelte v3.55.1 */
    const file = "App\\privacy.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Use this page to detail your site's privacy policy.";
    			add_location(h1, file, 7, 8, 202);
    			add_location(p, file, 8, 8, 228);
    			attr_dev(div, "class", "container svelte-1fbwoe2");
    			add_location(div, file, 6, 4, 169);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, getValue, title });
    ...
    var Privacy_entry = new Privacy({ target: document.body });

    return Privacy_entry;
