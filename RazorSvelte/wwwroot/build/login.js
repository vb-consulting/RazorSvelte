var login = (function () {
    ...
    */
    ...
    /* App\login.svelte generated by Svelte v3.55.1 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file, 10, 20, 363);
    			attr_dev(a0, "class", "btn btn-primary btn-lg");
    			attr_dev(a0, "href", urls.signInGoogleUrl);
    			add_location(a0, file, 9, 16, 277);
    			attr_dev(li0, "class", "list-group-item border-0");
    			add_location(li0, file, 8, 12, 222);
    			attr_dev(i1, "class", "bi bi-linkedin");
    			add_location(i1, file, 16, 20, 628);
    			attr_dev(a1, "class", "btn btn-primary btn-lg");
    			attr_dev(a1, "href", urls.signInLinkedInUrl);
    			add_location(a1, file, 15, 16, 540);
    			attr_dev(li1, "class", "list-group-item border-0");
    			add_location(li1, file, 14, 12, 485);
    			attr_dev(i2, "class", "bi bi-github");
    			add_location(i2, file, 22, 20, 895);
    			attr_dev(a2, "class", "btn btn-primary btn-lg");
    			attr_dev(a2, "href", urls.signInGitHubUrl);
    			add_location(a2, file, 21, 16, 809);
    			attr_dev(li2, "class", "list-group-item border-0");
    			add_location(li2, file, 20, 12, 754);
    			attr_dev(ul, "class", "list-group border-0");
    			add_location(ul, file, 7, 8, 176);
    			attr_dev(div, "class", "container text-center m-5 svelte-bmfybb");
    			add_location(div, file, 6, 4, 127);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, ul);
