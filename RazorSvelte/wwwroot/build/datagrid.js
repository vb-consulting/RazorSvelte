var datagrid = (function () {
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a6, file$2, 22, 4, 1082);
    			attr_dev(li6, "class", "nav-item py-0");
    			add_location(li6, file$2, 21, 0, 1050);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 86, 25, 2454);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 88, 8, 2705);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$1, 89, 8, 2846);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$1, 101, 20, 3256);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$1, 102, 20, 3342);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$1, 100, 16, 3167);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$1, 99, 12, 3117);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[3]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$1, 121, 20, 4335);
    ...
    /* App\datagrid.svelte generated by Svelte v3.55.1 */
    const file = "App\\datagrid.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Datagrid', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Datagrid> was created with unknown prop '${key}'`);
    	});
    ...
    class Datagrid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var DataGrid_entry = new Datagrid({ target: document.body });

    return DataGrid_entry;
