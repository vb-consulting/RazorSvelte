var chartdemo = (function () {
    ...
    */
    ...
    /* App\chartdemo.svelte generated by Svelte v3.55.1 */
    const file = "App\\chartdemo.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "ChartDemo";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Content here";
    			add_location(h1, file, 5, 8, 133);
    			add_location(p, file, 7, 8, 169);
    			attr_dev(div, "class", "container text-center svelte-bmfybb");
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Chartdemo', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Chartdemo> was created with unknown prop '${key}'`);
    	});
    ...
    class Chartdemo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var ChartDemo_entry = new Chartdemo({ target: document.body });

    return ChartDemo_entry;
