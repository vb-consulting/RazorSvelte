var datatable = (function () {
    ...
    */
    ...
    const file$3 = "App\\lib\\offcanvas.svelte";
    ...
    class Offcanvas extends SvelteComponentDev {
    	constructor(options) {
    		...
    		init$1(this, options, instance_1, create_fragment$4, safe_not_equal, {
    			backdrop: 12,
    			keyboard: 13,
    			scroll: 14,
    			state: 0,
    ...
    let user = { isSigned: false, name: "" };
    let themeKey = "__theme";
    let title = document.title || document.location.pathname.replace(/\//g, "");
    let logoutUrl = "/logout";
    let loginUrl = "/login";
    function setUser(value) { user = value; }
    function setErrorKey(value) { }
    function setThemeKey(value) { themeKey = value; }
    function setTitle(value) { title = value; }
    function setCacheVersion(value) { }
    function setUrlPrefix(value) { }
    function setIndexUrl(value) { }
    function setLogoutUrl(value) { logoutUrl = value; }
    function setLoginUrl(value) { loginUrl = value; }
    function setErrorUrl(value) { }
    function setNotFoundUrl(value) { }
    ...
    /* App\lib\offcanvas-layout.svelte generated by Svelte v3.55.1 */

    const { document: document_1 } = globals;
    const file$2 = "App\\lib\\offcanvas-layout.svelte";
    const get_links_slot_changes_1 = dirty => ({});
    const get_links_slot_context_1 = ctx => ({});
    ...
    function create_if_block_1(ctx) {
    	...
    	let offcanvas_1;
    	let current;
    	let if_block = !/*offcanvas*/ ctx[1].open && create_if_block_2(ctx);

    	offcanvas_1 = new Offcanvas({
    			props: {
    				state: /*offcanvas*/ ctx[1],
    				class: "offcanvas-nav navbar-dark bg-primary",
    				use: /*useOffcanvas*/ ctx[3],
    	...
    	offcanvas_1.$on("hidden", /*hidden_handler*/ ctx[10]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*offcanvas*/ 2) offcanvas_1_changes.state = /*offcanvas*/ ctx[1];
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "gutter svelte-1u9sajs");
    			add_location(div, file$2, 83, 25, 2335);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div, "mouseover", /*gutterMouseover*/ ctx[5], false, false, false),
    ...
    // (85:4) <Offcanvas state={offcanvas} class="offcanvas-nav navbar-dark bg-primary" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>
    function create_default_slot$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	const links_slot_template = /*#slots*/ ctx[8].links;
    	const links_slot = create_slot(links_slot_template, ctx, /*$$scope*/ ctx[13], get_links_slot_context);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			ul = element("ul");
    			if (links_slot) links_slot.c();
    			attr_dev(button, "class", "btn btn-sm btn-primary pin bi-pin-angle svelte-1u9sajs");
    			attr_dev(button, "data-bs-toggle", "tooltip");
    			attr_dev(button, "title", "Pin sidebar");
    			add_location(button, file$2, 85, 8, 2586);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$2, 86, 8, 2727);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    			...
    			if (links_slot) {
    				links_slot.m(ul, null);
    			}

    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*togglePin*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (links_slot) {
    				if (links_slot.p && (!current || dirty & /*$$scope*/ 8192)) {
    					update_slot_base(
    						links_slot,
    						links_slot_template,
    						ctx,
    						...
    						: get_slot_changes(links_slot_template, /*$$scope*/ ctx[13], dirty, get_links_slot_changes),
    		...
    		d: function destroy(detaching) {
    			...
    			if (links_slot) links_slot.d(detaching);
    			mounted = false;
    			dispose();
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(85:4) <Offcanvas state={offcanvas} class=\\\"offcanvas-nav navbar-dark bg-primary\\\" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 113, 24, 3910);
    			attr_dev(a, "class", "btn btn-sm btn-primary");
    			attr_dev(a, "href", loginUrl);
    			add_location(a, file$2, 112, 20, 3832);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			pre.textContent = `                        ${user.name}
                    `;

    			t3 = space();
    			a = element("a");
    			i = element("i");
    			attr_dev(pre, "class", "user-info text-nowrap svelte-1u9sajs");
    			attr_dev(pre, "data-bs-toggle", "tooltip");
    			attr_dev(pre, "title", "Current user");
    			add_location(pre, file$2, 105, 20, 3435);
    			attr_dev(i, "class", "bi bi-box-arrow-right");
    			add_location(i, file$2, 109, 24, 3722);
    			attr_dev(a, "class", "btn btn-sm btn-primary");
    			attr_dev(a, "href", logoutUrl);
    			attr_dev(a, "data-bs-toggle", "tooltip");
    			attr_dev(a, "title", "Logout");
    			add_location(a, file$2, 108, 20, 3603);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = !/*pinned*/ ctx[0] && create_if_block_1(ctx);
    	...
    	const links_slot_template = /*#slots*/ ctx[8].links;
    	const links_slot = create_slot(links_slot_template, ctx, /*$$scope*/ ctx[13], get_links_slot_context_1);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i0, "class", i0_class_value = /*offcanvas*/ ctx[1].open && !/*pinned*/ ctx[0]
    			? "bi-x"
    			: "bi-list");

    			add_location(i0, file$2, 98, 20, 3154);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$2, 99, 20, 3240);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$2, 97, 16, 3065);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$2, 96, 12, 3015);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[2]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$2, 118, 20, 4222);
    			attr_dev(button1, "class", "btn btn-sm btn-primary mx-1");
    			attr_dev(button1, "data-bs-toggle", "tooltip");
    			attr_dev(button1, "title", button1_title_value = /*$isDarkTheme*/ ctx[2] ? "Lights On" : "Lights Off");
    			add_location(button1, file$2, 117, 16, 4033);
    			attr_dev(div1, "class", "d-flex float-end");
    			add_location(div1, file$2, 103, 12, 3346);
    			attr_dev(div2, "class", "container-fluid");
    			add_location(div2, file$2, 94, 8, 2970);
    			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark fixed-top bg-primary py-0 py-md-0");
    			add_location(nav, file$2, 93, 4, 2877);
    			attr_dev(header, "class", "svelte-1u9sajs");
    			add_location(header, file$2, 92, 0, 2863);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-sm btn-primary pin bi-pin svelte-1u9sajs");
    			attr_dev(button2, "data-bs-toggle", "tooltip");
    			attr_dev(button2, "title", "Unpin sidebar");
    			add_location(button2, file$2, 128, 12, 4555);
    			attr_dev(div3, "class", "position-fixed pin-wrap svelte-1u9sajs");
    			add_location(div3, file$2, 127, 8, 4504);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4 position-fixed");
    			add_location(ul, file$2, 130, 8, 4722);
    			attr_dev(div4, "class", "offcanvas-nav navbar-dark bg-primary svelte-1u9sajs");
    			toggle_class(div4, "d-none", !/*pinned*/ ctx[0]);
    			add_location(div4, file$2, 126, 4, 4421);
    			attr_dev(main, "class", "svelte-1u9sajs");
    			toggle_class(main, "pinned-layout", /*pinned*/ ctx[0]);
    			add_location(main, file$2, 125, 0, 4380);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(document_1.body, "mouseover", /*bodyMouseover*/ ctx[6], false, false, false),
    					...
    					listen_dev(button2, "click", /*togglePin*/ ctx[7], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*offcanvas, pinned*/ 3 && i0_class_value !== (i0_class_value = /*offcanvas*/ ctx[1].open && !/*pinned*/ ctx[0]
    			? "bi-x"
    			: "bi-list")) {
    			...
    			if (!current || dirty & /*$isDarkTheme*/ 4 && i1_class_value !== (i1_class_value = /*$isDarkTheme*/ ctx[2]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off")) {
    				attr_dev(i1, "class", i1_class_value);
    			}

    			if (!current || dirty & /*$isDarkTheme*/ 4 && button1_title_value !== (button1_title_value = /*$isDarkTheme*/ ctx[2] ? "Lights On" : "Lights Off")) {
    			...
    			if (links_slot) {
    				if (links_slot.p && (!current || dirty & /*$$scope*/ 8192)) {
    					update_slot_base(
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[13])
    						: get_slot_changes(links_slot_template, /*$$scope*/ ctx[13], dirty, get_links_slot_changes_1),
    						get_links_slot_context_1
    					);
    				}
    			}

    			if (!current || dirty & /*pinned*/ 1) {
    				toggle_class(div4, "d-none", !/*pinned*/ ctx[0]);
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, isDarkTheme, $$value => $$invalidate(2, $isDarkTheme = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Offcanvas_layout', slots, ['links','default']);
    	...
    	function toggleOffcanvas(state) {
    		if (pinned) {
    			$$invalidate(0, pinned = false);
    			return;
    		}

    		if (state == undefined) {
    			$$invalidate(1, offcanvas.open = !offcanvas.open, offcanvas);
    		} else {
    			$$invalidate(1, offcanvas.open = state, offcanvas);
    		}
    	}
    		...
    		gutterTimeout = setTimeout(
    			() => {
    				if (!offcanvas.open && document && document.querySelectorAll(".gutter:hover").length > 0) {
    					$$invalidate(1, offcanvas.open = true, offcanvas);
    				}
    		...
    		bodyTimeout = setTimeout(
    			() => {
    				if (offcanvas.open && !offcanvasRef.querySelectorAll(".offcanvas-body:hover").length) {
    					$$invalidate(1, offcanvas.open = false, offcanvas);
    				}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('offcanvas' in $$props) $$invalidate(1, offcanvas = $$props.offcanvas);
    ...
    /* App\shared\link-list-items.svelte generated by Svelte v3.55.1 */
    const file$1 = "App\\shared\\link-list-items.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li3 = element("li");
    			a3 = element("a");
    			t7 = text("Card Component Demo");
    			t8 = space();
    			li4 = element("li");
    			a4 = element("a");
    			t9 = text("Chart Components Demo");
    			t10 = space();
    			li5 = element("li");
    			a5 = element("a");
    			t11 = text("DataTable Components Demo");
    			t12 = space();
    			li6 = element("li");
    			a6 = element("a");
    			t13 = text("FileSelector");
    			attr_dev(a0, "class", "nav-link ");
    			attr_dev(a0, "href", urls.indexUrl);
    			toggle_class(a0, "active", document.location.pathname == urls.indexUrl);
    			add_location(a0, file$1, 4, 4, 92);
    			attr_dev(li0, "class", "nav-item py-0");
    			add_location(li0, file$1, 3, 0, 60);
    			attr_dev(a1, "class", "nav-link");
    			attr_dev(a1, "href", urls.authorizedUrl);
    			toggle_class(a1, "active", document.location.pathname == urls.authorizedUrl);
    			add_location(a1, file$1, 7, 4, 244);
    			attr_dev(li1, "class", "nav-item py-0");
    			add_location(li1, file$1, 6, 0, 212);
    			attr_dev(a2, "class", "nav-link");
    			attr_dev(a2, "href", urls.spaUrl);
    			toggle_class(a2, "active", document.location.pathname == urls.spaUrl);
    			add_location(a2, file$1, 10, 4, 418);
    			attr_dev(li2, "class", "nav-item py-0");
    			add_location(li2, file$1, 9, 0, 386);
    			attr_dev(a3, "class", "nav-link");
    			attr_dev(a3, "href", urls.cardDemoUrl);
    			toggle_class(a3, "active", document.location.pathname == urls.cardDemoUrl);
    			add_location(a3, file$1, 13, 4, 572);
    			attr_dev(li3, "class", "nav-item py-0");
    			add_location(li3, file$1, 12, 0, 540);
    			attr_dev(a4, "class", "nav-link");
    			attr_dev(a4, "href", urls.chartDemoUrl);
    			toggle_class(a4, "active", document.location.pathname == urls.chartDemoUrl);
    			add_location(a4, file$1, 16, 4, 744);
    			attr_dev(li4, "class", "nav-item py-0");
    			add_location(li4, file$1, 15, 0, 712);
    			attr_dev(a5, "class", "nav-link");
    			attr_dev(a5, "href", urls.dataTableUrl);
    			toggle_class(a5, "active", document.location.pathname == urls.dataTableUrl);
    			add_location(a5, file$1, 19, 4, 920);
    			attr_dev(li5, "class", "nav-item py-0");
    			add_location(li5, file$1, 18, 0, 888);
    			attr_dev(a6, "class", "nav-link");
    			attr_dev(a6, "href", urls.fileSelectorUrl);
    			toggle_class(a6, "active", document.location.pathname == urls.fileSelectorUrl);
    			add_location(a6, file$1, 22, 4, 1100);
    			attr_dev(li6, "class", "nav-item py-0");
    			add_location(li6, file$1, 21, 0, 1068);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* App\shared\layout.svelte generated by Svelte v3.55.1 */
    ...
    // (7:4) <svelte:fragment slot="links">
    function create_links_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_links_slot.name,
    		type: "slot",
    		source: "(7:4) <svelte:fragment slot=\\\"links\\\">",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, Links: Link_list_items });
    	return [slots, $$scope];
    }
    ...
    /* App\datatable.svelte generated by Svelte v3.55.1 */
    const file = "App\\datatable.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "DataTable Component Demo";
    			t1 = space();
    			p = element("p");
    			t2 = text("DataTable Component is implemenation of ");
    			a = element("a");
    			a.textContent = "bootstrap tables";
    			add_location(h3, file, 6, 8, 133);
    			attr_dev(a, "href", "https://getbootstrap.com/docs/5.3/content/tables/");
    			add_location(a, file, 7, 51, 218);
    			add_location(p, file, 7, 8, 175);
    			attr_dev(div, "class", "container text-center");
    			add_location(div, file, 4, 4, 88);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Layout_1 });
    	return [];
    }
    ...
    function init(pageName) {
        ...
        setUser(getValueFromJson("user"));
        setErrorKey((_a = getValue("error-key")) !== null && _a !== void 0 ? _a : "");
        setThemeKey((_b = getValue("theme-key")) !== null && _b !== void 0 ? _b : "");
        setTitle(getValue("title"));
        setCacheVersion((_c = getValue("cache-version")) !== null && _c !== void 0 ? _c : "");
        setUrlPrefix((_d = getValue("url-prefix")) !== null && _d !== void 0 ? _d : "");
    ...
    var _a;
    var DataTable_entry = new Datatable({ target: document.body, props: (_a = init("DataTable")) !== null && _a !== void 0 ? _a : {} });

    return DataTable_entry;
