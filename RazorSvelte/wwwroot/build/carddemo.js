var carddemo = (function () {
    ...
    */
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block2 = /*subtitle*/ ctx[2] && create_if_block(ctx);
    ...
    /* App\carddemo.svelte generated by Svelte v3.55.1 */
    const file = "App\\carddemo.svelte";
    ...
    // (12:8) <Card class="mt-3 text-center">
    function create_default_slot_2(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Slot Content Centered");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:8) <Card class=\\\"mt-3 text-center\\\">",
    		ctx
    	});
    ...
    // (15:8) <Card class="mt-3" title="title">
    function create_default_slot_1(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Card 2 Content");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:8) <Card class=\\\"mt-3\\\" title=\\\"title\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 6, 8, 160);
    			attr_dev(div, "class", "container svelte-bmfybb");
    			add_location(div, file, 5, 4, 128);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Carddemo', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Carddemo> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, Card });
    	return [];
    }

    class Carddemo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var CardDemo_entry = new Carddemo({ target: document.body });

    return CardDemo_entry;
