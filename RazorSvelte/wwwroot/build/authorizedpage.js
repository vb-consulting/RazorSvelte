var authorizedpage = (function () {
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a4, file$2, 16, 4, 734);
    			attr_dev(li4, "class", "nav-item py-0");
    			add_location(li4, file$2, 15, 0, 702);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* App\authorized-page.svelte generated by Svelte v3.55.1 */
    const file = "App\\authorized-page.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Authorized Access Page";
    			t1 = space();
    			ul = element("ul");
    			li0 = element("li");
    			li0.textContent = `Name: ${user.name}`;
    			t4 = space();
    			li1 = element("li");
    			li1.textContent = `Email: ${user.email}`;
    			t7 = space();
    			li2 = element("li");
    			li2.textContent = `Timezone: ${user.timezone}`;
    			t10 = space();
    			li3 = element("li");
    			li3.textContent = `Timestamp: ${user.timestamp}`;
    			add_location(h1, file, 6, 8, 182);
    			attr_dev(li0, "class", "list-group-item");
    			add_location(li0, file, 8, 12, 277);
    			attr_dev(li1, "class", "list-group-item");
    			add_location(li1, file, 11, 12, 373);
    			attr_dev(li2, "class", "list-group-item");
    			add_location(li2, file, 14, 12, 471);
    			attr_dev(li3, "class", "list-group-item");
    			add_location(li3, file, 17, 12, 575);
    			attr_dev(ul, "class", "list-group list-group-flush");
    			add_location(ul, file, 7, 8, 223);
    			attr_dev(div, "class", "container text-center m-5 svelte-4iagcu");
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Authorized_page', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Authorized_page> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, user });
    	return [];
    }

    class Authorized_page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var AuthorizedPage_entry = new Authorized_page({ target: document.body });

    return AuthorizedPage_entry;
